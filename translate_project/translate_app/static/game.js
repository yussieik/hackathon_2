...
let selectqlanguage = (qbutton) => {
    ...
    // document.querySelector(".question-container").setAttribute("style", "background-image: url('https://www.alleganyco.gov/wp-content/uploads/American-Flag-51-1024x681.jpg')");
...
// background for answer language
...
const handleGuess = async (e) => {
    ...
    if (userGuess.toLowerCase() === aTranslation.toLowerCase()) {
        ...
        document.querySelector("#streak").setAttribute("style", `font-size: ${STREAK % 5 * 1.05}rem`)
...
const images = {
    ...
    "he": "url('https://as2.ftcdn.net/v2/jpg/00/23/26/23/1000_F_23262322_GVir9E0aBGsZZ28JDM1uGgWn3uPGZ7Bg.jpg')",
    "ru": "url('https://www.advantour.com/russia/images/symbolics/russia-flag_sm.jpg')",
    "fr": "url('https://i.ebayimg.com/images/g/NqsAAOSw4B9fkYQq/s-l1600.jpg')",
